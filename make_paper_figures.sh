...
GRAPHALIGNER_FAST_COLOR=${NEW_COLOR}
...
HIFI_SIM_1M_HEADLINE_CATEGORIES="${MINIMAP_HIFI} ${WINNOWMAP} ${PBMM} ${GIRAFFE_PRIMARY} ${MINIGRAPH_MINIGRAPH} ${GRAPHALIGNER_MINIGRAPH} ${GRAPHALIGNER_DEFAULT} ${GIRAFFE} ${GIRAFFE_SAMPLED}"
...
R10_SIM_1M_HEADLINE_CATEGORIES="${MINIMAP_R10} ${WINNOWMAP} ${GIRAFFE_PRIMARY} ${MINIGRAPH_MINIGRAPH} ${GRAPHALIGNER_MINIGRAPH} ${GRAPHALIGNER_DEFAULT} ${GIRAFFE} ${GIRAFFE_SAMPLED}"
...
HIFI_REAL_FULL_HEADLINE_CATEGORIES="${MINIMAP_HIFI} ${WINNOWMAP} ${PBMM} ${GIRAFFE_PRIMARY} ${MINIGRAPH_MINIGRAPH} ${GRAPHALIGNER_FAST} ${GRAPHALIGNER_DEFAULT} ${GRAPHALIGNER_FAST} ${GIRAFFE} ${GIRAFFE_SAMPLED}"
HIFI_REAL_FULL_HEADLINE_COLORS="${MINIMAP_COLOR} ${WINNOWMAP_COLOR} ${PBMM_COLOR} ${GIRAFFE_PRIMARY_COLOR} ${MINIGRAPH_MINIGRAPH_COLOR} ${GRAPHALIGNER_FAST_COLOR} ${GRAPHALIGNER_DEFAULT_COLOR} ${GRAPHALIGNER_FAST_COLOR} ${GIRAFFE_COLOR} ${GIRAFFE_SAMPLED_COLOR}"
R10_REAL_FULL_HEADLINE_CATEGORIES="${MINIMAP_R10} ${WINNOWMAP} ${GIRAFFE_PRIMARY} ${MINIGRAPH_MINIGRAPH} ${GRAPHALIGNER_FAST} ${GRAPHALIGNER_DEFAULT} ${GRAPHALIGNER_FAST} ${GIRAFFE} ${GIRAFFE_SAMPLED}"
R10_REAL_FULL_HEADLINE_COLORS="${MINIMAP_COLOR} ${WINNOWMAP_COLOR} ${GIRAFFE_PRIMARY_COLOR} ${MINIGRAPH_MINIGRAPH_COLOR} ${GRAPHALIGNER_FAST_COLOR} ${GRAPHALIGNER_DEFAULT_COLOR} ${GRAPHALIGNER_FAST_COLOR} ${GIRAFFE_COLOR} ${GIRAFFE_SAMPLED_COLOR}"
