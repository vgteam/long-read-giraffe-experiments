...
python3 barchart.py <(tail -n +2 ${HIFI_INCORRECT} | cut -f1,5) --divisions <(tail -n +2 ${HIFI_INCORRECT} | cut -f1,4)  --title 'HiFi incorrect read count' --y_label 'Count' --x_label 'Condition' --x_sideways --no_n --categories ${MINIMAP_HIFI} ${WINNOWMAP} ${PBMM} ${GIRAFFE_PRIMARY} ${MINIGRAPH_MINIGRAPH} ${GRAPHALIGNER_DEFAULT} ${GIRAFFE} ${GIRAFFE_SAMPLED}  --colors ${MINIMAP_COLOR} ${WINNOWMAP_COLOR} ${PBMM_COLOR} ${GIRAFFE_PRIMARY_COLOR} ${MINIGRAPH_COLOR} ${GRAPHALIGNER_COLOR} ${GIRAFFE_COLOR} ${GIRAFFE_SAMPLED_COLOR} --save ${OUT_DIR}/incorrectness_hifi.pdf

python3 barchart.py <(tail -n +2 ${R10_INCORRECT} | cut -f1,5) --divisions <(tail -n +2 ${R10_INCORRECT} | cut -f1,4)  --title 'R10 incorrect read count' --y_label 'Count' --x_label 'Condition' --x_sideways --no_n --categories ${MINIMAP_R10} ${WINNOWMAP} ${GIRAFFE_PRIMARY} ${MINIGRAPH_MINIGRAPH} ${GRAPHALIGNER_DEFAULT} ${GIRAFFE} ${GIRAFFE_SAMPLED}  --colors ${MINIMAP_COLOR} ${WINNOWMAP_COLOR} ${GIRAFFE_PRIMARY_COLOR} ${MINIGRAPH_COLOR} ${GRAPHALIGNER_COLOR} ${GIRAFFE_COLOR} ${GIRAFFE_SAMPLED_COLOR}  --save ${OUT_DIR}/incorrectness_r10.pdf
...
python3 barchart.py ${HIFI_SOFTCLIPS} --max ${LIMIT}  --title 'HiFi Softclipped or Unmapped Bases' --y_label 'Percent of bases' --x_label 'Mapper' --x_sideways --no_n --categories ${MINIMAP_HIFI} ${WINNOWMAP} ${GIRAFFE_PRIMARY} ${MINIGRAPH_MINIGRAPH} ${GRAPHALIGNER_DEFAULT} ${GIRAFFE} ${GIRAFFE_SAMPLED}  --colors ${MINIMAP_COLOR} ${WINNOWMAP_COLOR} ${GIRAFFE_PRIMARY_COLOR} ${MINIGRAPH_COLOR} ${GRAPHALIGNER_COLOR} ${GIRAFFE_COLOR} ${GIRAFFE_SAMPLED_COLOR} --save ${OUT_DIR}/softclips_hifi_headline_low.pdf

#hifi softclips high
LIMIT=$(python3 get_outlier_limit.py ${HIFI_SOFTCLIPS} big)
python3 barchart.py ${HIFI_SOFTCLIPS} --min ${LIMIT}  --title 'HiFi Softclipped or Unmapped Bases' --y_label 'Percent of bases' --x_label 'Mapper' --x_sideways --no_n --categories ${MINIMAP_HIFI} ${WINNOWMAP} ${GIRAFFE_PRIMARY} ${MINIGRAPH_MINIGRAPH} ${GRAPHALIGNER_DEFAULT} ${GIRAFFE} ${GIRAFFE_SAMPLED}  --colors ${MINIMAP_COLOR} ${WINNOWMAP_COLOR} ${GIRAFFE_PRIMARY_COLOR} ${MINIGRAPH_COLOR} ${GRAPHALIGNER_COLOR} ${GIRAFFE_COLOR} ${GIRAFFE_SAMPLED_COLOR} --save ${OUT_DIR}/softclips_hifi_headline_high.pdf

#r10 softclips
python3 barchart.py ${R10_SOFTCLIPS} --title 'R10 Softclipped or Unmapped Bases' --y_label 'Percent of bases' --x_label 'Mapper' --x_sideways --no_n --categories ${MINIMAP_R10} ${WINNOWMAP} ${GIRAFFE_PRIMARY} ${MINIGRAPH_MINIGRAPH} ${GRAPHALIGNER_DEFAULT} ${GIRAFFE} ${GIRAFFE_SAMPLED}  --colors ${MINIMAP_COLOR} ${WINNOWMAP_COLOR} ${GIRAFFE_PRIMARY_COLOR} ${MINIGRAPH_COLOR} ${GRAPHALIGNER_COLOR} ${GIRAFFE_COLOR} ${GIRAFFE_SAMPLED_COLOR} --save ${OUT_DIR}/softclips_r10_headline_high.pdf
...
python3 barchart.py <(awk -v OFS='\t' '{{print $1,$2/60}}' ${HIFI_RUNTIME}) --divisions <(awk -v OFS='\t' '{{print $1,$2/60}}' ${HIFI_INDEX_TIME}) --min ${LIMIT}  --title 'HiFi Runtime' --y_label 'Time (hours)' --x_label 'Mapper' --x_sideways --no_n --categories ${MINIMAP_HIFI} ${WINNOWMAP} ${GIRAFFE_PRIMARY} ${MINIGRAPH_MINIGRAPH} ${GRAPHALIGNER_DEFAULT} ${GIRAFFE} ${GIRAFFE_SAMPLED}  --colors ${MINIMAP_COLOR} ${WINNOWMAP_COLOR} ${GIRAFFE_PRIMARY_COLOR} ${MINIGRAPH_COLOR} ${GRAPHALIGNER_COLOR} ${GIRAFFE_COLOR} ${GIRAFFE_SAMPLED_COLOR} --save ${OUT_DIR}/runtime_hifi_headline_slow.pdf

# Lower hifi runtimes
LIMIT=$(python3 get_outlier_limit.py <(awk -v OFS='\t' '{{print $1,$2/60}}' ${HIFI_RUNTIME}) small)
python3 barchart.py <(awk -v OFS='\t' '{{print $1,$2/60}}' ${HIFI_RUNTIME}) --divisions <(awk -v OFS='\t' '{{print $1,$2/60}}' ${HIFI_INDEX_TIME}) --max ${LIMIT}  --title 'HiFi Runtime' --y_label 'Time (hours)' --x_label 'Mapper' --x_sideways --no_n --categories ${MINIMAP_HIFI} ${WINNOWMAP} ${GIRAFFE_PRIMARY} ${MINIGRAPH_MINIGRAPH} ${GRAPHALIGNER_DEFAULT} ${GIRAFFE} ${GIRAFFE_SAMPLED}  --colors ${MINIMAP_COLOR} ${WINNOWMAP_COLOR} ${GIRAFFE_PRIMARY_COLOR} ${MINIGRAPH_COLOR} ${GRAPHALIGNER_COLOR} ${GIRAFFE_COLOR} ${GIRAFFE_SAMPLED_COLOR} --save ${OUT_DIR}/runtime_hifi_headline_fast.pdf

# R10 runtimes as one plot
python3 barchart.py <(awk -v OFS='\t' '{{print $1,$2/60}}' ${R10_RUNTIME}) --divisions <(awk -v OFS='\t' '{{print $1,$2/60}}' ${R10_INDEX_TIME}) --title 'R10 Runtime' --y_label 'Percent of bases' --x_label 'Mapper' --x_sideways --no_n --categories ${MINIMAP_R10} ${WINNOWMAP} ${GIRAFFE_PRIMARY} ${MINIGRAPH_MINIGRAPH} ${GRAPHALIGNER_DEFAULT} ${GIRAFFE} ${GIRAFFE_SAMPLED}  --colors ${MINIMAP_COLOR} ${WINNOWMAP_COLOR} ${GIRAFFE_PRIMARY_COLOR} ${MINIGRAPH_COLOR} ${GRAPHALIGNER_COLOR} ${GIRAFFE_COLOR} ${GIRAFFE_SAMPLED_COLOR} --save ${OUT_DIR}/runtime_r10_headline.pdf
...
python3 barchart.py ${HIFI_MEMORY} --title 'HiFi Memory From Benchmark' --y_label 'Memory (GB)' --x_label 'Mapper' --x_sideways --no_n --categories ${MINIMAP_HIFI} ${WINNOWMAP} ${GIRAFFE_PRIMARY} ${MINIGRAPH_MINIGRAPH} ${GRAPHALIGNER_DEFAULT} ${GIRAFFE} ${GIRAFFE_SAMPLED}  --colors ${MINIMAP_COLOR} ${WINNOWMAP_COLOR} ${GIRAFFE_PRIMARY_COLOR} ${MINIGRAPH_COLOR} ${GRAPHALIGNER_COLOR} ${GIRAFFE_COLOR} ${GIRAFFE_SAMPLED_COLOR}  --save ${OUT_DIR}/memory_hifi.pdf

python3 barchart.py ${R10_MEMORY} --title 'R10 Memory From Benchmark' --y_label 'Memory (GB)' --x_label 'Mapper' --x_sideways --no_n --categories ${MINIMAP_R10} ${WINNOWMAP} ${GIRAFFE_PRIMARY} ${MINIGRAPH_MINIGRAPH} ${GRAPHALIGNER_DEFAULT} ${GIRAFFE} ${GIRAFFE_SAMPLED}  --colors ${MINIMAP_COLOR} ${WINNOWMAP_COLOR} ${GIRAFFE_PRIMARY_COLOR} ${MINIGRAPH_COLOR} ${GRAPHALIGNER_COLOR} ${GIRAFFE_COLOR} ${GIRAFFE_SAMPLED_COLOR} --save ${OUT_DIR}/memory_r10.pdf
