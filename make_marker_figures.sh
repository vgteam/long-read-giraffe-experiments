...
Rscript plot-calling-results.R renamed.tsv ./dv_total_summary.pdf "$(cat renamed.tsv | tail -n +1 | cut -f1 | tr '\n' ';')" "Long Read Giraffe + DeepVariant Total"
# ImageMagick thinks reading a PDF is too insecure to even contemplate, despite
# implementing it, so we use pdftoppm <https://superuser.com/a/185897>
pdftoppm -png dv_total_summary.pdf dv_total_summary
